...
function renderList(list) {
    ...
    list.forEach(u => {
        ...
        d.innerHTML = `
            <div style="flex:1"><span class="status-dot ${st}"></span> <b>${u.username}</b> <span style="opacity:0.6; font-size:9px;">${u.dept}</span></div>
            <div style="display:flex; gap:5px;">
                ...
                <img src="assets/icon-small-delete-14x15.png" style="cursor:pointer" onclick="act('delete','${u.id}')">
            </div>`;
        c.appendChild(d);
    });
}
