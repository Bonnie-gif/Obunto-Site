...
function loadData() { var s = localStorage.getItem('vintageSiteDatav22'); if(s) try { data = JSON.parse(s); } catch(e){} render(); }
function saveData() { localStorage.setItem('vintageSiteDatav22', JSON.stringify(data)); }
